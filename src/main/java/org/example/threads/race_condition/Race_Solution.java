...
public class Race_Solution extends Thread {
    ...
    // ***********************************************************
    // static int count = 0;
    // static Lock lock1 = new ReentrantLock(); // should be static or else rach
    // thread have this
    // own lock and gain race condition will occur
    //
    // public void run (){
    //
    // for(int i=0; i < 20000; i++) {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        obj1.join(); /// we give .join to make main thread to wait until .join() thread (obj1,obj2)
                     /// to finish
        obj2.join();
